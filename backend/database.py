...
class Users(db.Model):
    ...
    projects = db.relationship('Projects', secondary=projects_association_table)
...
class UserValuesInt(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    attribute_id = db.Column(db.Integer, db.ForeignKey('user_attributes.id'), nullable=False)
...
class TransactionValuesFloat(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    attribute_id = db.Column(db.Integer, db.ForeignKey('transaction_attributes.id'), nullable=False)
...
class TransactionParents(db.Model):
    ...
    parent_id = db.Column(db.Integer, db.ForeignKey('transactions.id'), primary_key=True)
